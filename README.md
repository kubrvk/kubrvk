...
<br>
U.N. Owen Was Her is a third-person atmospheric horror game built in Unreal Engine. The player is trapped inside the Scarlet Mansion a haunted estate populated by entities derived from the U.N. Owen figure. The game is structured around a Feed-or-Fight decision loop: enemies can be pacified through a hunger-state system that transforms their behavior and form, or engaged directly using a limited-ammo weapon set. Puzzle progression is tied to entity state, environmental manipulation, and resource management.
<br clear="left"/>
<p align="center">
