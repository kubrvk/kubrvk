...
<br>
Mobile platformer built in Unreal Engine, targeting Android. Controls the Queen through vertically-ascending levels where momentum, timing, and clean input determine progress. The game is built around a physics-driven movement model with touch-optimized controls, all input handling, movement feel, and jump behavior are tuned specifically for mobile touch input latency and screen real estate constraints.
<br clear="left"/>
<p align="center">
